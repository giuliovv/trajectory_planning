...
[Ustar,fxstar,niter,exitflag,xsequence] =myfmincon(@(alpha)mycostfunction_constrained(n,rightpoints,leftpoints,alpha, kl, kr, gamma),alpha0,A,b,C,d,0,1,myoptions);
